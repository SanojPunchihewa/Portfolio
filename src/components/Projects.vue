           ...
           <div class="card">
            <div class="card-content">
              <div class="content">
                ...
                <div class="has-text-centered">
                  <a class="button is-outlined" target="_blank" :href="value.link">View Project</a>
                </div>                
                <div class="tags" style="margin-top:10px">
                  <span style="fontSize:0.8rem" v-for="(value) in value.tech" :key="value.id" class="tag is-light-blue-green bold-tag">{{value}}</span>
                </div>
              </div>
            </div>
          </div>
